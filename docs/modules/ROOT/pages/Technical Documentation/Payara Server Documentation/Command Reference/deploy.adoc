...
ifeval::["{page-site-edition}" == "community"]
  `warlibs={false|true}`;;
      ...
      This feature is intended to allow a developer to create skinny WARs. +
      This differs to common and application libraries by being cached (they don't dynamically update if the files are modified), and getting additional annotation and extension scanning & processing for CDI, EJB, Servlet, and more.
endif::[]
