...
The *Write to System Log* option allow you to enable and disable the action of logging to the system log. When disabled this should help to minimize disk usage.
...
Use the following command to enable or disable the logging to the system log feature:
