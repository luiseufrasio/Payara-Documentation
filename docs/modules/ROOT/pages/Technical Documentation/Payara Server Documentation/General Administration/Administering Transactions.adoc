...
** The `recover-txn-delay` default of `-1` means that recovery will be attempted upon start of the server. Use this property to delay the initial execution of the recovery thread. The units are seconds.
