...
|`cacheTTL` |`5000` |This property configures the time to live (TTL) in milliseconds of the virtual server cache for serving files.

You can also set this property for all the web applications on a specific virtual server.
This property will take precedence over the virtual server configuration.
