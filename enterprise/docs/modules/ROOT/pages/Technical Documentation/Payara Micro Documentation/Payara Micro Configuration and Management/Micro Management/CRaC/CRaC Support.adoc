...
NOTE: While checkpointing after application deployment will speed up the "ready time" of the instance upon restoration, the nature and content of any deployed applications may lead to checkpoint or restoration errors.
